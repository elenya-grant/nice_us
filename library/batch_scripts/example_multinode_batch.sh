...
srun -N 8 --ntasks-per-node=78 /projects/surint/campd_spheres/national_analysis/environment_folder/h2i_env/bin/python /projects/surint/campd_spheres/national_analysis/software/nice_us/simulation/run_plants.py
